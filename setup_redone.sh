...
sudo pacman -Syu zsh steam fish base-devel git gnome-keyring hyprlock hypridle hyprpaper impala spotify-launcher swww swaync unzip nautilus vscode rofi fastfetch btop discord flatpak nwg-look otf-geist-mono-nerd impala --noconfirm
